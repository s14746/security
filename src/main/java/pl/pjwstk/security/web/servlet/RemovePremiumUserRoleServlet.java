...
@WebServlet("/users/removePremiumUserRole")
public class RemovePremiumUserRoleServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        assignUserRoleToUserService.assign(req.getParameter("username"), UserRole.REGULAR);
